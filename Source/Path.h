...
typedef enum 
{
    PATH_SONG = 0,
    ASSET_PLAY_BUTTON,
    ASSET_PLAY_BUTTON_ONCLICK,
    ASSET_PAUSE_BUTTON,
    ASSET_PAUSE_BUTTON_ONCLICK,
    ASSET_SOUND_MUTED,
    ...
    ASSET_SOUND3,
    ASSET_RANDOM_BUTTON,
    ASSET_RANDOM_BUTTON_ONCLICK,
    ASSET_RANDOM_BUTTON_CLICKON,
    ASSET_RANDOM_BUTTON_CLICK,

    ASSET_REPEAT_BUTTON,
    ASSET_REPEAT_BUTTON_ONCLICK,
    ASSET_REPEAT_BUTTON_CLICKON,
    ASSET_REPEAT_BUTTON_CLICK,

    ASSET_SOUND_ONCLICK,
    ASSET_SCENE_CONFIG,
    ASSET_SCENE_CONFIG_ONCLICK,
    ASSET_3DBUTTON_OFF,
    ASSET_3DBUTTON_ON,
    ASSET_VST,
    ASSET_XML_DATA,
